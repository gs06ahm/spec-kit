...
def projects_enable(
    ...
    from .github import resolve_github_token, load_config, save_config, GitHubProjectsConfig
    ...
    try:
        remote_url = run_command(["git", "remote", "get-url", "origin"], capture=True)
        if not remote_url:
    ...
    if config.enabled:
        ...
        console.print("\nDo you want to reconfigure? [y/N]: ", end="")
...
def projects_disable():
    ...
    from .github import load_config, save_config
...
def projects_status():
    ...
    from .github import load_config
...
def projects_sync(
    ...
    from .github import resolve_github_token, load_config
    ...
    if not tasks_file:
        # Look for tasks.md in specs/ directories
